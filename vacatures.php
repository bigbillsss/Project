...
<body>
    ...
    <main class="vacature-box">
        <section class="menu-body">
        <section class="section-padding">
            <h2 class="section-title">VACATURES</h2>
            <p class="allergieen">Bij Umami Sushi draait alles om beleving. We serveren niet zomaar eten; we bieden onze gasten een reis door de Japanse keuken met een moderne twist. Ons team is jong, energiek en altijd op zoek naar perfectie—of dat nu in een perfect gerolde Maki zit of in een glimlach aan de deur.</p>
        </section>
        </section>
